...
class RdataTB {
    ...
    Control() {
        ...
        <tr>
          <td style="width:100%; display: flex; justify-content: space-between; margin-bottom: 10px;">
             ...
             <input id="SearchControl" class="form-control shadow-none" placeholder="جستجو" type="text" style="width: 145px;height:40px">
          </td>
        </tr>
      </table>
        `;
    ...
    PaginateUpdate() {
        if (document.getElementById('PF') != null) {
            ...
            <a style="">صفحه ${this.i + 1} به ${this.Divide().length} از ${(this.DataTable === undefined) ? 0 : this.DataTable.length} ورودی</a>`;
        }
    }
    search() {
        var _a;
