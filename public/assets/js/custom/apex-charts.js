(function() {
    ...
    var options = {
        series: [
            {
                name: 'صفحه در هر بازدید 7.56',
                data: [30, 35, 55, 40, 10, 20, 50],
            }, {
                name: 'میانگین مدت زمان بازدید 05:48',
    ...
    var options = {
        series: [{
            ...
            {
                name: "بازدیدکنندگان منحصر به فرد",
                data: [80, 25 , 40, 20, 50, 25, 30, 0]
            },
            {
                name: "بازدیدکنندگان قبلی",
	...
	var options = {
		...
		xaxis: {
			categories: ['ایالات متحده', 'چین', 'کانادا', 'اندونزی', 'روسیه', 'بنگلادش', 'برزیل', 'بریتانیا', 'ویتنام', 'هند'],
			labels: {
				style: {
					colors: ['#A9A9C8', '#A9A9C8', '#A9A9C8', '#A9A9C8', '#A9A9C8', '#A9A9C8', '#A9A9C8', '#A9A9C8', '#A9A9C8', '#A9A9C8', '#A9A9C8', '#A9A9C8',],
				},
    ...
    var options = {
        ...
        labels: ['هدف', 'هفته قبل', 'آخر ماه', 'امروز'],
	...
	var options = {
		...
		labels: ['تکمیل شده', 'فعال', 'اختصاص داده', 'در انتظار'],
    ...
    var options = {
        ...
        labels: ['بیتکوین', 'اتریوم', 'دلار', 'ماتیک'],
